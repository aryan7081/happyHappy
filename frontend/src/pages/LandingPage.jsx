...
const LandingPage = () => {
  ...
  const handleBuy = async (planId) => {
    ...
    try {
      ...
      const response = await fetch(
        `${config.apiBaseUrl}/api/memberships/`,
        payload
      );
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Group Classes',
      description:
        'High-energy group workouts including HIIT, Yoga, Pilates, and more.',
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: 'Expert Trainers',
      description:
        'Certified professionals with years of experience in fitness training.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Personalized meal plans and nutrition counseling for optimal results.',
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: 'Progress Tracking',
      description:
        'Advanced analytics to monitor your fitness journey and achievements.',
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        'Rao Fitness transformed my fitness journey completely. The trainers are amazing and the facilities are top-notch!',
      rating: 5,
      image:
    ...
    },
    {
      ...
      content:
        "Best gym experience I've ever had. The 24/7 access fits perfectly with my schedule, and the results speak for themselves.",
      rating: 5,
      image:
    ...
    },
    {
      ...
      role: 'Teacher',
      content:
        "The group classes are incredible! I've made great friends and achieved fitness goals I never thought possible.",
      rating: 5,
      image:
    ...
    <div className="min-h-screen bg-white">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'bg-white shadow-lg'
            : 'lg:bg-transparent bg-black/10 backdrop-blur-sm'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {['Home', 'About', 'Trainers', 'Classes', 'Pricing'].map(
                (item) => (
                  <a
                    key={item}
            ...
            {/* CTA Button */}
            <button
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-full font-semibold transition-all transform hover:scale-105 shadow-lg"
      ...
      <section
        id="home"
        className="relative h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 overflow-hidden"
      >
        {/* Background Pattern */}
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 lg:pt-0 xs:pt-52 pt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button
              onClick={openRegisterModal}
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:scale-105 shadow-xl flex items-center space-x-2"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              supportive, motivating environment with cutting-edge facilities.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {trainers.map((trainer, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2 border border-gray-100"
              >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Take a look at our modern gym facilities designed to provide you
              with the best workout experience possible.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Real stories from real people who transformed their lives at Rao
              Fitness.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join Rao Fitness today and get your first week absolutely free. No
            commitment required - just results guaranteed.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-400">
                    123 Fitness St, Health City, HC 12345
                  </span>
                </div>
                <div className="flex items-center space-x-3">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 Rao Fitness. All rights reserved. | Privacy Policy | Terms
              of Service
            </p>
          </div>
        </div>
      ...
      {showRegisterModal && (
        <Signup closeModals={closeModals} openLoginModal={openLoginModal} />
      )}
    </div>
  );
};
